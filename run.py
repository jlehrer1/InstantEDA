...
parser.add_argument(
    "-w", "--write", help="Write pdf to specified directory if it exists, else writes to current")
...
if __name__ == "__main__":
    ...
    if (df.isnull().sum().sum() > 0):
        key = input(
            "Data contains missing values. Would you like to compute and continue? [Y/n]: ")
